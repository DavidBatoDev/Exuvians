 ...
 * @param {Object} data - Transparency data (barangayId, title, description, imageUrl, pdfUrl)
 * @returns {Object} - Newly created transparency record with ID
 */
export const createTransparencyRecord = async ({ barangayId, title, description, imageUrl, pdfUrl }) => {
  try {
